...
describe('CoveyTownController', () => {
  ...
  describe('town listeners and events', () => {
    ...
    it('should notify added listeners of player movement when onPlayerMovement is called', async () => {
      const player = new Player('test player');
      await testingTown.addPlayer(player);
      const newLocation = generateTestLocation();
      mockListeners.forEach(listener => testingTown.addTownListener(listener));
      testingTown.onPlayerMovement(player, newLocation);
    ...
    it('should not notify removed listeners of player movement when onPlayerMovement is called', async () => {
      const player = new Player('test player');
      await testingTown.addPlayer(player);
  ...
  describe('townSubscriptionHandler', () => {
    ...
    describe('with a valid session token', () => {
      ...
      it('should add a town listener, which should emit "playerMoved" to the socket when a player moves', async () => {
        TestUtils.setSessionTokenAndTownID(testingTown.coveyTownID, session.sessionToken, mockSocket);
        townSubscriptionHandler(mockSocket);
        testingTown.onPlayerMovement(player, generateTestLocation());
