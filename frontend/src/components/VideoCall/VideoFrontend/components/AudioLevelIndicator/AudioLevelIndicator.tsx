  ...
  return isTrackEnabled ? (
    <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' data-test-audio-indicator>
      ...
      <g fill='none' fillRule='evenodd' transform='translate(.5)'>
        <rect clipPath={`url(#${clipPathId})`} width='5.2' height='10' x='9.5' y='3.5' rx='6' ry='3' fill='#23BF6E' />
        <path
          fill={color}
          strokeWidth='0'
    ...
    <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' transform='translate(-0.5, 0)' data-test-audio-mute-icon>
