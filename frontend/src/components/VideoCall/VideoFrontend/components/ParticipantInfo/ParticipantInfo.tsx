...
export default function ParticipantInfo({ participant, profile, onClick, isSelected, children, isLocalParticipant, hideParticipant, slot, insideGrid, highlight }: ParticipantInfoProps) {
